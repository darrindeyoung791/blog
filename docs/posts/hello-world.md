...
本文为 Darrin's Blog 的第一篇文章。今天起 Darrin's Blog 正式上线！

查看 [关于](../about.md) 获取更多信息。

---

以下是 Markdown 格式检测，来自 [github-flavored-markdown-test](https://github.com/suan/github-flavored-markdown-test)
...
![image link](https://raw.githubusercontent.com/suan/github-flavored-markdown-test/refs/heads/master/afu.png)